                ...
                sidebarLinks.map((link) => {
                    ...
                    return (
                        <SheetClose asChild key={link.route}>
                            ...
                            >
                                <Image className={`${isActive ? '' : 'invert-colors'}`} src={link.imgURL} alt={link.label} width={20} height={20} />
    ...
    return (
        <Sheet>
            <SheetTrigger asChild>
                <Image src="/assets/icons/hamburger.svg" width={36} height={36} className="invert-colors sm:hidden" alt="Menu" />
            </SheetTrigger>
